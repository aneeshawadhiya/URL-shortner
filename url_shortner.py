...
# Creating Canvas 
# place() method is used to place element in canvas according to (x,y) axis
canvas = Canvas(root, bg="#3A7FF6", height=519, width=862,
...
labelIntro = Label(root, text='Instagram : @aneeshawadhiya',
                   bg='white', fg='black')
label1 = Label(root, text='Enter the URL: ', bg='white', fg='black')
text1 = Entry(root, textvariable=orignalURL,
              width=50, bg='#dfe3eb', fg='black')

button1 = Button(root, text="Shorten", command=shorten,
                 width=20, bg='#3A7FF6', fg='white')

label2 = Label(root, text='Shortened URL: ', bg='white', fg='black')
text2 = Entry(root, textvariable=shortenedURL,
              width=50, bg='#dfe3eb', fg='black')
...
smallTitle = Label(text="WELCOME", bg="#3A7FF6", justify='left',
                   fg="white", font=("Arial-BoldMT", int(10.0)))
smallTitle.place(x=35.0, y=90.0)

title = Label(text="URL SHORTNER", bg="#3A7FF6", justify='left',
...
github_text = Label(text="Github :\n"
                   "@aneeshawadhiya",bg="#3A7FF6", fg="white", justify="left", font=("Arial-BoldMT", int(12.0)))

info_text.place(x=35.0, y=200.0)
github_text.place(x=35.0, y=290.0)
